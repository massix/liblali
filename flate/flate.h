...
extern Flate *flateSetFile(Flate **tmplte, const char *filename);
...
extern void flateSetVar(Flate *tmplte, const char *fld, const char *val);
extern void flateDumpTableLine(Flate *tmplte, const char *line);
extern void flatePrint(Flate *tmplte, const char *type);
